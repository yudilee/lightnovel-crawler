...
- **"Service"** means the Lightnovel-Crawler web application, Python package, API, CLI tools, and all associated features, functionality, services, and infrastructure.
- **"User," "you," or "your"** refers to any individual or entity that accesses, uses, or registers for the Service.
- **"Content"** means any text, images, data, information, URLs, eBooks, or other materials accessed, processed, generated, stored, or distributed through the Service.
- **"User Content"** means any content that you provide, upload, submit, or make available through the Service, including URLs, generated eBooks, and processed materials.
- **"Account"** means the user account you create to access and use the Service.
- **"API"** means the application programming interface provided by the Service.
- **"CLI"** means the command-line interface tool distributed as a Python package.
...
- Provide URLs to online novels and other web-based content sources
- Crawl, extract, and process text and images from provided URLs
- Generate, download, and share full eBooks in various formats
- Store and manage processed content and generated eBooks
...
- You may encounter adult or sensitive content
- You are responsible for determining what content is appropriate for you
- The Service does not filter, restrict, or moderate content based on age or appropriateness
- You must comply with all applicable laws regarding access to adult content in your jurisdiction
...
- Age restrictions for accessing certain content
- Content restrictions based on jurisdiction
...
## 6. Content Responsibility and Ownership

### 6.1 User Responsibility

Users are **solely responsible** for:

- The URLs they provide to the Service
- The content they choose to crawl, extract, or process
- The eBooks they generate, download, store, or share
- Ensuring they have the legal right to access, process, and use any content
- Compliance with all applicable laws, including copyright, intellectual property, and content-related regulations
- Any legal consequences, claims, or liabilities arising from their use of the Service or their actions
...
### 6.2 No Ownership Claim

The Service and its owner claim **no ownership rights** over:

- Crawled content from third-party sources
- Generated eBooks or processed materials
- User-provided URLs or source information
- Any content created, processed, or stored through the Service
...
- Guarantee the availability or accessibility of third-party sources
...
## 7. Copyright and DMCA Notice-and-Takedown Policy
...
### 7.4 DMCA Takedown Notice Requirements
...
4. **Contact Information:** Information reasonably sufficient to permit the Service to contact you, such as:
...
### 7.5 Processing of DMCA Takedown Notices

Upon receipt of a valid DMCA takedown notice that substantially complies with the requirements set forth in Section 7.4:

1. **Review:** We will review the notice to ensure it contains all required elements and is properly formatted.

2. **Removal:** If the notice is valid and complete, we will expeditiously remove or disable access to the allegedly infringing material, typically within 48 hours of receipt of a valid notice.

3. **User Notification:** We will notify the user who posted or stored the content that the material has been removed or disabled, and provide them with a copy of the takedown notice (with your contact information redacted if requested for privacy reasons).

4. **No Guarantee:** While we strive to process valid notices promptly, we do not guarantee any specific timeframe for removal. Processing time may vary based on the completeness of the notice and other factors.

### 7.6 Counter-Notification Procedure
...
#### 7.6.1 Counter-Notification Requirements
...
#### 7.6.2 Processing of Counter-Notifications

1. **Review:** Upon receipt of a valid counter-notification, we will review it to ensure it contains all required elements.

2. **Forwarding:** We will forward the counter-notification to the original complaining party, along with your contact information.

3. **Restoration:** We will restore the removed material or cease disabling access to it not less than 10, nor more than 14, business days following receipt of the counter-notification, unless our designated copyright agent first receives notice from the party filing the original notification that such person has filed an action seeking a court order to restrain you from engaging in infringing activity relating to the material on the Service.

4. **No Guarantee:** We do not guarantee that material will be restored, and restoration is subject to the original complaining party not filing a court action within the specified timeframe.
...
### 7.8 No Legal Determinations

The Service does not make legal determinations regarding:

- Ownership, validity, or enforceability of copyrights
- Whether material is actually infringing
- Whether use of material constitutes fair use or is otherwise authorized
...
- Legal judgments or determinations
- Admissions of liability or wrongdoing
- Waivers of any rights or defenses

### 7.9 Reservation of Rights

The Service reserves the right, but not the obligation, to:

- Remove or disable access to any content at any time for any reason, including but not limited to:
  - Legal risk or potential liability
  - Operational concerns
  - Policy enforcement
  - Violation of these Terms of Service
- Modify this DMCA policy as necessary
- Take any other action we deem appropriate to protect the Service, users, or third parties

### 7.10 Contact Information for DMCA Matters
...
- Any additional API-specific terms or usage policies
- Rate limiting and usage restrictions as determined by us
...
- These Terms of Service
- The GPL-v3 License under which the software is distributed
- Any additional terms provided with the CLI distribution

### 8.3 Access Limitations

We reserve the right to:

- Limit API or Service access to prevent abuse
- Suspend or terminate API access for any reason
- Implement rate limiting, usage quotas, or other restrictions
- Modify API functionality or availability without notice
...
- Abuses, overloads, or disrupts the Service or its infrastructure
- Attempts to gain unauthorized access to the Service, accounts, or systems
- Interferes with or disrupts the availability, security, or functionality of the Service
- Uses automated systems, bots, or scripts to access the Service in a manner that exceeds reasonable use
...
- Transmits or distributes malicious code, viruses, or harmful software

### 9.3 Harmful Content

- Processes, stores, or distributes content that is illegal, harmful, threatening, abusive, or violates the rights of others
- Uses the Service to harass, stalk, or harm others
- Violates privacy rights or distributes private information without consent

### 9.4 Commercial Use Restrictions

- Uses the Service for commercial purposes that violate these Terms
- Resells, redistributes, or commercially exploits the Service without authorization
- Uses the Service to compete with or harm the Service or its operations
...
- Restrict, limit, or suspend your access to the Service or API
- Delete or remove any content associated with your account
- Take any other action we deem necessary or appropriate

### 10.2 Grounds for Suspension or Termination

Suspension or termination may occur for any reason, including but not limited to:

- Violation of these Terms of Service
- Abuse of the Service or infrastructure
- Excessive resource usage or bandwidth consumption
- Engaging in prohibited uses as described in Section 9
- Legal or regulatory requirements
- Security concerns or threats
- Any other reason we deem necessary to protect the Service, other users, or our interests
...
- All data associated with your account may be permanently deleted
- You will not be entitled to any refund, compensation, or data recovery
...
- Maintenance, updates, or modifications
- Technical failures or issues
...
- Add or remove features, functionality, or services
- Change API endpoints, functionality, or availability
- Implement usage limits, restrictions, or requirements
- Make any other changes to the Service without prior notice
...
- **Accuracy:** No warranty regarding the accuracy, completeness, or reliability of any content, data, or information
- **Availability:** No warranty that the Service will be available, uninterrupted, secure, or error-free
- **Uptime:** No warranty regarding service uptime, reliability, or performance
- **Data Integrity:** No warranty that data will not be lost, corrupted, or deleted
- **Fitness for Purpose:** No warranty that the Service will meet your requirements or be suitable for any particular purpose
- **Non-Infringement:** No warranty that the Service does not infringe the rights of third parties
- **Merchantability:** No warranty of merchantability
...
- The Service may contain errors, bugs, or other issues
- We are not responsible for any damage to your computer system, data, or other property resulting from your use of the Service
...
- Any content accessed, processed, or generated through the Service
- Unauthorized access to or use of the Service or your account
...
- Any legal claims, disputes, or actions arising from your use of the Service
...
### 13.4 User Assumption of Risk

You acknowledge and agree that you assume all risks associated with your use of the Service, including but not limited to:

- Risks related to content accuracy, legality, or appropriateness
- Risks related to data loss, corruption, or deletion
- Risks related to copyright infringement or intellectual property claims
- Risks related to service availability, interruptions, or modifications
- Any other risks inherent in using an online service
...
- Any content you submit, post, transmit, or make available through the Service
- Your violation of any intellectual property or other rights of any person or entity
- Any claims or actions brought by third parties related to your use of the Service
...
- Imply any warranty or support obligation
- Grant any rights beyond those provided in the GPL-v3 license
- Obligate us to provide technical support, maintenance, or updates
- Guarantee the continued availability of the source code

### 15.3 No Warranty from Source Code
...
### 16.1 Service Intellectual Property
...
- If negotiation fails, through appropriate legal channels as determined by applicable law
- Any other dispute resolution mechanism as required by applicable law
...
- Changes in the Service or our business practices
- Legal or regulatory requirements
- Improvements or clarifications to the Terms
...
- You understand the risks and limitations associated with using the Service
